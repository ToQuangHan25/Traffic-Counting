...
Để đảm bảo tính khoa học, về mặt dữ liệu huấn luyện, đề tài sử dụng bộ dữ liệu TSBOW (Traffic Surveillance Benchmark for Occluded Vehicles Under Various Weather Conditions) chuyên biệt về giao thông trong điều kiện thời tiết xấu và bị che khuất. Về phương pháp triển khai mô hình, đề tài sử dụng mô hình mạng học sâu YOLO 11 tích hợp thuật toán theo dõi đa đối tượng Tracking, xây dựng logic đếm xe để chạy thử nghiệm trên các video giao thông thực tế.
