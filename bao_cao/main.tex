...
%----------------------------------------------------------------------------------------
\begin{abbreviations}{l p{0.8\textwidth}} % Thêm danh sách tên viết tắt (dưới dạng một bảng có 2 cột)

\textbf{AI} & \textbf{T}rí \textbf{T}uệ \textbf{N}hân \textbf{T}ạo\\
\textbf{AP} & \textbf{A}verage \textbf{P}recision\\
\textbf{C2PSA} & \textbf{C}ross \textbf{S}tage \textbf{P}artial \textbf{S}patial \textbf{A}ttention\\
\textbf{CNN} & \textbf{C}onvolutional \textbf{N}eural \textbf{N}etwork\\
\textbf{CPU} & \textbf{C}entral \textbf{P}rocessing \textbf{U}nit\\
\textbf{CSP} & \textbf{C}ross \textbf{S}tage \textbf{P}artial\\
\textbf{GPU} & \textbf{G}raphics \textbf{P}rocessing \textbf{U}nit\\
\textbf{IoU} & \textbf{I}ntersection over \textbf{U}nion\\
\textbf{mAP} & mean \textbf{A}verage \textbf{P}recision\\
\textbf{NMS} & \textbf{N}on \textbf{M}aximum \textbf{S}uppression\\
\textbf{RAM} & \textbf{R}andom \textbf{A}ccess \textbf{M}emory\\
\textbf{RoI} & \textbf{R}egion of \textbf{I}nterest\\
\textbf{SPPF} & \textbf{S}patial \textbf{P}yramid \textbf{P}ooling \textbf{F}ast\\
\textbf{TSBOW} & \textbf{T}raffic \textbf{S}urveillance \textbf{B}enchmark for \textbf{O}ccluded Vehicles Under Various \textbf{W}eather Conditions\\
